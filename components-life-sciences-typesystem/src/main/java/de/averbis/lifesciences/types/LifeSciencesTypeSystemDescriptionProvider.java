 ...
 */
package de.averbis.lifesciences.types;
...
public class LifeSciencesTypeSystemDescriptionProvider extends TypeSystemProvider_ImplBase {

	public LifeSciencesTypeSystemDescriptionProvider() {

		setTypeSystemLocations( //
				"LifeSciencesTypeSystem.xml");
	}
}
